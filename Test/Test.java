...
/**
 * This test class is our initial unit testing class. The code in Data.java was changed and instead of these tests being updated here, we created separate files. See DataTest.java, and the remainder files.
 *
 */
//
class DataTest {
...
//
//
//    // Tests for CreateAGoal. Set category to null since categorization occurs in a different method.
//    // Test 1: Provide both valid inputs and ensure a goal is created
//    @Test
//    void createValidGoal() {
//        boolean result = Data.createAGoal("Become fit", 7, null); // Provide both valid inputs
//        assertTrue(result);
//    }
//
...
//        boolean result = Data.createAGoal("Gain Knowledge", 7, null);
//        assertFalse(result);
//    }
//
...
//        boolean result = Data.createAGoal("GAINKNOWLEDGE", 7, null);
//        assertFalse(result);
//    }
//
//
